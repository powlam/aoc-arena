<div class="flex-grow w-full sm:w-auto">
    <ul>
        @foreach(App\Models\Archetype::all() as $archetype)
            <li @class([
                    "flex items-center justify-between h-20 p-2 rounded-md",
            ...
            >
                ...
                <img src="{{ Vite::asset('resources/images/'.$archetype->imageName) }}" alt="{{ $archetype->name }} archetype's symbol" class="w-20">
            </li>
        @endforeach
    </ul>
</div>
